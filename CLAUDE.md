...
- **Vídeo aprovado nunca é sobrescrito.** Versão nova de vídeo da hero entra com nome próprio (`hero-scrub-v2.mp4`, `-v3`, ...) e convive com a que está no ar. O arquivo em uso só é substituído depois de UAT aprovado pelo Pedro, e mesmo então o anterior permanece no repositório. Pedido explícito dele em 22/09/2026: quer o vídeo atual como garantia e alternativa caso o novo não agrade. Isto REVOGA a instrução de 07/08 que previa o arquivo novo entrando com o mesmo nome para evitar mudança de código.
